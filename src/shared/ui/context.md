...
- `isConnected?: boolean` — статус сети (обычно из useMemoryBankNetworkStatus)
...
import { useMemoryBankNetworkStatus } from '../memory-bank/localMemoryBank';

const isConnected = useMemoryBankNetworkStatus();
