...
**Описание:**
Масштабируемая архитектура для мобильного приложения с кастомной overlay-инфраструктурой (BottomSheet, Toast, GlobalModal), SectionList для группировки данных, Redux Toolkit + redux-persist для фильтров, истории, избранного, in-memory + AsyncStorage для быстрого кэширования, StackNavigator с поддержкой свайпов, локализацией (lingui.js), dark mode и полной типизацией.
...
- in-memory + AsyncStorage для быстрого кэширования
